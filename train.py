...
# print(adjs)
# print(scipy.sparse.identity(adjs[num_time_steps - 1].shape[0]).tocsr()[range(0, x.shape[0]), :] for x in adjs)
...
for epoch in range(FLAGS.epochs):
    ...
    if (epoch + 1) % FLAGS.test_freq == 0:
        ...
        emb = np.array(emb)
        np.savetxt(r'C:\Users\86138\Desktop\DySAT-master\ICEWS14_outemb.txt', emb)
        # print(emb)
        ...
        # print(epochs_embeds)
        # print(len(epochs_embeds[0]), len(epochs_embeds[0][1]))
        # input()
    epoch_loss /= it
...
# np.savetxt(r'C:\Users\86138\Desktop\DySAT-master\ICEWS14_outemb.txt', epochs_embeds[best_epoch])
# print(len(epochs_embeds[best_epoch]), len(emb[0]))
